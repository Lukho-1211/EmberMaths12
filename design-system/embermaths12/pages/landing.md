...
> Overrides `MASTER.md` for `/` only.

## Pattern

Hero + Features + CTA with full-bleed maths photo background and CAPS rhythm signature visual.
...
5. Mission — merged vision + mission
6. Contact + final CTA
7. Footer

## Nav

How it works · Features · Join · Contact (+ Log in / Sign up)

## Motion

CSS rise / stagger / glow only; respect `prefers-reduced-motion`.
